...
like( $out, qr{sed -i -f /tmp/lf[.]sed .*/20260501_03_0171[.]limb}, 'update_nans dry-run prints sed command' );
like( $out, qr{lf2mpr_nrt[.]pdl -inpdir .*-outdir .* -y 2026 -mo 5 -da 1 -h 3}, 'update_nans dry-run prints reducer command' );
...
is( $? >> 8, 0, 'run_limbfit_ymdh.pl continues after limbfit failure' ) or diag $out;
